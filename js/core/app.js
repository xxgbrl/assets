...
(function (window, document, $) {
  ...
  if ($body.attr('data-framework') === 'laravel') {
    ...
    var i18nLangSets = localStorage.getItem('i18n-lang-set');
    i18next.use(window.i18nextXHRBackend).init(
      ...
      function (err, t) {
        ...
        i18next.changeLanguage(i18nLangSets, function (err, t) {
            $('.i18n-lang').localize();
        });
        if (i18nLangSets !== null) {
            if(i18nLangSets == "id") {
                $('#dropdown-flag .selected-language').text("Indonesia");
                $('#dropdown-flag .flag-icon').removeClass().addClass("flag-icon flag-icon-id");
            }
        }
      }
    );
    ...
    $('.dropdown-language .dropdown-item').on('click', function () {
      ...
      i18next.changeLanguage(currentLanguage, function (err, t) {
        $('.i18n-lang').localize();
        localStorage.setItem('i18n-lang-set', currentLanguage);
      });
    });
  }
